...
finalscorefail.innerHTML='<span>Your Score was '+localStorage.getItem("finalScore")+'</span> <br><input type="button" name="gomain" value="Main Menu" id="main"><input type="button" name="gogame" value="Play again" id="game">';
